...
- 풀이 스크립트와 본 코드를 새로운 폴더에 넣고, 풀이 파일 이름을 '구분_유형_문제_풀이횟수.py'로 저장하면, 상위 디렉토리의 README.md에서 **구분**에 따라 테이블을 자동으로 생성합니다.
...
| 15 | baekjoon | 소수 | 소수 구하기 | ✅❗️ |  |  |  |
| 16 | baekjoon | 순열조합 | 암호 만들기 | ✅ |  |  |  |
| 17 | baekjoon | 투포인터 | 두 수의 합 | ✅ |  |  |  |
| 18 | baekjoon | 투포인터 | 두 용액 | ✅ | ✅ |  |  |
| 19 | baekjoon | DP | 팰린드롬? | ✅❗️ |  |  |  |
| 20 | baekjoon | 구현, 백트래킹 | 사다리 조작 | ✅❗️ |  |  |  |
| 21 | baekjoon | 그리디 | 보석 도둑 | ✅❗️ |  |  |  |
...
| 33 | baekjoon | 시뮬레이션 | 새로운 게임 2 | ✅ |  |  |  |
| 34 | baekjoon | 이분탐색 | 도토리 숨기기 | ✅❗️ |  |  |  |
| 35 | baekjoon | 백트래킹 | 소문난 칠공주 | ✅❗️ |  |  |  |
| 36 | baekjoon | 그래프 | 한 줄로 서기 | ✅ |  |  |  |
| 37 | baekjoon | 그래프 | 택배 배송 | ✅ |  |  |  |
| 38 | baekjoon | 최단거리 | 파티 | ✅ | ✅ |  |  |
| 39 | baekjoon | 브루트포스 | 하늘에서 별똥별이 빗발친다 | ✅ |  |  |  |
| 40 | baekjoon | DFS, BFS | 벽 부수고 이동하기 4 | ✅❗️ |  |  |  |
| 41 | baekjoon | 시뮬레이션 | 미친 아두이노 | ✅ |  |  |  |
| 42 | baekjoon | DFS, BFS | 회사문화1 | ✅❗️ |  |  |  |
| 43 | baekjoon | DP | 색상환 | ✅❗️ |  |  |  |
| 44 | baekjoon | 시뮬레이션 | 킹 | ✅ |  |  |  |
| 45 | baekjoon | BFS | 상범 빌딩 | ✅ |  |  |  |
| 46 | baekjoon | DP | 방 번호 | ✅❗️ |  |  |  |
...
## 삼성 SW Expert Academy 문제
| 순번 | 구분 | 유형 | 문제 | 1회 풀이 | 2회 풀이 | 3회 풀이 | 풀이 코드 |
| :-----: | :-----: | :-----: | :-----: | :-----: | :-----: | :-----: | ------- |
| 1 | SWEA | DFS, 구현 | 프로세서 연결하기 | ✅❗️ |  |  |
| 2 | SWEA | 백트래킹, 구현 | 등산로 조성 | ✅ |  |  |  |
| 3 | SWEA | 시뮬레이션 | 핀볼 게임 | ✅ |  |  |  |
...
| 9 | programmers | 수학 | 124 나라의 숫자 | ✅ |  |  |  |
| 10 | programmers | 힙 | 디스크 컨트롤러 | ✅❗️ |  |  |  |
| 11 | programmers | 그리디 | 체육복 | ✅ |  |  |  |
| 12 | programmers | 그리디, 투포인터 | 두 큐 합 같게 만들기 | ✅❗️ | ✅❗️ |  |  |
| 13 | programmers | DP | 등굣길 | ✅ |  |  |  |
...
| 28 | programmers | 스택, 큐 | 주식 가격 | ✅ |  |  |  |
| 29 | programmers | 그래프 | 등산코스 정하기 | ✅ |  |  |  |
| 30 | programmers | DFS,BFS | 타겟 넘버 | ✅ |  |  |  |
| 31 | programmers | 시뮬레이션 | 주차 요금 계산 | ✅ |  |  |  |
| 32 | programmers | 그래프 | 합승 택시 요금 | ✅ |  |  |  |
| 33 | programmers | BFS | 리코쳇 로봇 | ✅❗️ |  |  |  |
| 34 | programmers | BFS | 내리막길 | ✅❗️ |  |  |  |
| 35 | programmers | 카운터 | 시소 짝꿍 | ✅❗️ |  |  |  |
| 36 | programmers | 그래프 | 게임 개발 | ✅❗️ |  |  |  |

## SQL 문제
| 순번 | 구분 | 유형 | 문제 | 1회 풀이 | 2회 풀이 | 3회 풀이 | 풀이 코드 |
| :-----: | :-----: | :-----: | :-----: | :-----: | :-----: | :-----: | ------- |
| 1 | sql | JOIN | 없어진 기록 찾기 | ✅ |  |  |
| 2 | sql | GROUP BY | 동명 동물 수 찾기 | ✅ |  |  |  |
| 3 | sql | STRING | 조건에 맞는 사용자 정보 조회하기 | ✅❗️ |  |  |  |
| 4 | sql | STRING | 조회수가 가장 많은 중고거래 게시판의 첨부파일 조회하기 | ✅❗️ |  |  |  |
